...
export const investmentFeeImpactContent = {
  ko: {
    title: "투자 수수료 영향 계산기",
    description: "장기 투자에서 연간 운용 수수료가 최종 자산에 미치는 영향을 수수료가 없는 경우와 비교합니다.",
    category: "투자 계산기",
    input: "투자 조건",
    ...
    method: "같은 투자금과 기간에 대해 수수료가 없는 기준 자산과 수수료 차감 후 자산을 각각 계산한 뒤 두 값의 차이를 장기 수수료 영향으로 표시합니다.",
    cautions: "세금, 거래 수수료, 실제 시장 변동, 상품별 수수료 부과 방식은 반영하지 않습니다. 실제 상품의 비용 구조를 반드시 확인하세요.",
    metaTitle: "투자 수수료 영향 계산기 | 장기 수수료 비용 계산",
  },
  en: {
    title: "Investment Fee Impact Calculator",
    description: "Compare how an annual investment management fee can reduce a portfolio's long-term ending value versus a no-fee scenario.",
    ...
    method: "The calculator projects the same cash flows twice: once at the gross expected return and once after subtracting the annual management fee. The difference is shown as estimated fee drag.",
    cautions: "Taxes, trading costs, market volatility, and product-specific fee mechanics are excluded. Check the actual fee schedule before making an investment decision.",
